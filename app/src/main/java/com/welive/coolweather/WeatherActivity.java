...
import com.welive.coolweather.gson.Forecast;
import com.welive.coolweather.gson.Weather;
import com.welive.coolweather.service.MyService;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        实现沉寂标题栏
         */
        if (Build.VERSION.SDK_INT >= 21) {//6.0系统
        ...
        //有这个字段，表示已经查询过该地址的天气状况，那么直接去请求后台数据
    ...
    private void showWeatherInfo(Weather weather) {
        ...
        if (weather != null && "ok".equals(weather.status)) {
            ...
            String updateTime = weather.basic.update.updateTime.split(" ")[1];//拆分并取值
     ...
     * @param weatherId
     */
    public static void intentAction(Context context, String weatherId) {
